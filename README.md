...
class ArnavTripathi:
    def __init__(self):
        ...
        self.education = "B.Tech Computer Science @ VIT Bhopal"
        self.focus = [
            "Generative AI & LLMs",
            "Computer Vision & Image Recognition",
            "Full-Stack Web Development (React & FastAPI)"
        ]
        self.interests = "Building scalable, production-ready AI solutions"
        self.contact = "arnavtripathi21045@gmail.com"
...
* 🧠 **Generative AI & LLMs** (Prompt Engineering, Multimodal Systems, GANs)
* 👁️ **Computer Vision** (Real-time Object Detection, Traffic Violation Reporting)
* 🌐 **Full-Stack Development** (React 19, FastAPI, Scalable Backends)
* 📊 **Predictive Analytics** (Random Forest, LSTM, Machine Learning)
...
* **Virtual Intern — Google Cloud Generative AI, NASSCOM** *(Jul 2025 – Sep 2025)*
  ▸ Worked on Generative AI concepts including LLMs, GANs, and multimodal AI systems.
